...
<div x-data="{{ json_encode(['show' => true, 'style' => $style, 'message' => $message]) }}"
    :class="{ 'fixed inset-x-0 z-[9999]': true, 'bg-orange-500': style == 'success', 'bg-red-700': style ==
        'danger', 'bg-gray-500': style != 'success' && style != 'danger' }"
        ...
        <div class="flex items-center justify-between flex-wrap">
            ...
            <div class="flex-shrink-0 sm:ml-3">
                <button type="button" class="-mr-1 flex p-2 rounded-md focus:outline-none sm:-mr-2 transition"
                    :class="{ 'hover:bg-orange-600 focus:bg-orange-600': style ==
